...
@section('content')
    <div class="d-flex justify-content-center bg-light border border-2 p-3" style="margin-top: 2%; margin-bottom: 2%">
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#CriarAnot">
            Criar anotação
        </button>
        ...
        <!-- Modal -->
        <div class="modal fade" id="CriarAnot" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Criar anotação</h1>
